...
export const results: ResultsDictionary = {
  ...
  bestFit: {
    ...
    compositeSectionTitle: "Lead methodologies in composite case",
    compositeSectionDescription:
      "Review the lead methodology first, then the critical complement that covers the second active role in this composite case.",
    closeFitSectionDescription:
      "Start with the current leader, but read the nearby alternative as a secondary option rather than a composite recommendation.",
    badge: "Best fit",
    compositeLeadBadge: "Lead role match",
    compositeComplementBadge: "Critical complement",
    closeFitBadge: "Best current fit",
  ...
  alternatives: {
    ...
    supportingBadge: "Supporting alternative",
  ...
  export: {
    ...
    report: {
      ...
      rankedComparisonTitle: "Ranked comparison",
      topFitAnalysisTitle: "Why the top recommendation fits",
      secondaryStrategyTitle: "Secondary or complementary strategy",
      dimensionProfileTitle: "Dimension profile",
      methodologyNotesTitle: "Methodology notes",
      recommendationModeLabel: "Recommendation mode",
      readingGuidanceLabel: "Reading guidance",
      primaryRecommendationLabel: "Primary recommendation",
      complementaryRecommendationLabel: "Complementary role",
      keyDriversLabel: "Key drivers",
      signalSummaryLabel: "Decision pattern",
      rankingPreviewLabel: "Ranking preview",
      methodologyLabel: "Methodology",
      fitLabel: "Fit label",
      coreRoleLabel: "Core role",
      strongestDimensionsLabel: "Strongest dimensions",
      rationaleLabel: "Rationale",
      strongestDiscriminatorLabel: "Strongest discriminator",
      nearestAlternativeLabel: "Nearest alternative",
      lowestFitPatternLabel: "Lowest-fit pattern",
      whyItLeadsLabel: "Why it leads",
      caveatsLabel: "Risks and caveats",
      whyNotOthersLabel: "Why not the others",
      recommendedFirstMoveLabel: "Recommended first move",
      whatRaisesAlternativeLabel: "What raises the alternative",
      switchingConditionsLabel: "Switching conditions",
      stayWithTopLabel: "When to stay with the top recommendation",
      moveTowardAlternativeLabel: "When to move toward the alternative",
      operationalDifferenceLabel: "Operational difference",
      currentSignalLabel: "Current signal",
      effectOnRecommendationLabel: "Effect on recommendation",
      supportsMethodologyLabel: "Supports most",
      decisionWeightLabel: "Decision weight",
      decisiveLabel: "Decisive",
      supportiveLabel: "Supportive",
      neutralLabel: "Neutral",
      answerMappingLabel: "Answer-to-dimension mapping",
      whenItWouldFitLabel: "When it would fit",
      whyItRankedLowerLabel: "Why it ranked lower here",
      rankingShiftLabel: "How the ranking changes",
    },
  },
  interpretation: {
  ...
  narrative: {
    ...
    reasonPhrases: {
      ...
      adaptiveScope: "backlog-managed change and adaptive planning",
